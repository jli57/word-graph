...
/* harmony import */ var _util_api_util__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./util/api_util */ "./src/util/api_util.js");
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! d3 */ "./node_modules/d3/d3.js");
...
/* harmony import */ var webcola__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! webcola */ "./node_modules/webcola/dist/index.js");
/* harmony import */ var webcola__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(webcola__WEBPACK_IMPORTED_MODULE_7__);
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var height = 400;
  var R = 15;
  var svg = d3__WEBPACK_IMPORTED_MODULE_6__["select"]("#canvas").append("svg").attr("width", width).attr("height", height).style("border", "1px solid black");
  Object(_util_api_util__WEBPACK_IMPORTED_MODULE_5__["fetchRelated"])(word, function (graph) {
    console.log(graph);
    ...
    var d3cola = webcola__WEBPACK_IMPORTED_MODULE_7__["d3adaptor"](d3__WEBPACK_IMPORTED_MODULE_6__).size([width, height]).linkDistance(50).symmetricDiffLinkLengths(5).avoidOverlaps(true).nodes(graph.nodes).links(graph.links).on('tick', function () {
